...
public class ReportRecruitmentController {
    @FXML private LookupBox<Position> lookupBoxPosition;
    ...
    private void onViewReport(){
        ...
        if(selectedPos == null){
            Alert alert = new Alert(Alert.AlertType.WARNING, "No Position selected!",
                    ButtonType.OK);
            alert.showAndWait();
            return;
        }
        ...
        try{
            ...
            JasperReport jasperReport = (JasperReport) JRLoader.loadObject(
                getClass().getResourceAsStream("/reports/ReportRecruitment.jasper")
            );
            
            // Ambil data dari service
            List<Recruitment> data = reportService.getRecruitmentReport(selectedPos.getName());
